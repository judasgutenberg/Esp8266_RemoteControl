...
void initConfig(void) {
  ...
  ci[GRANULARITY_WHEN_IN_HOTSPOT_PHASE_0] = 3;
  ci[GRANULARITY_WHEN_IN_HOTSPOT_PHASE_1] = 17;
  ci[NUMBER_OF_HOTSPOT_REBOOTS_BEFORE_ESP_REBOOT] = 4;
  ci[HOTSPOT_LIMITED_TIME_FRAME] = 340;
  ci[HOTSPOT_POWER_SWITCH] = 0;
