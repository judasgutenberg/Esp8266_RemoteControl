...
These files are to be placed on a server running some sort of web daemon, PHP, and MySQL (or MariaSQL).  I like that tech stack because the setup is easy, the performance is fine, and the stack is mature enough that updates don't generally break things.
