...
const char* sensor_config_string = ""; //"14*-1*2301*11*0*NULL*stank*1"; //an easy way to specify multiple sensors. the format is: dataPin*powerPin*sensorType*sensorSubType*i2c_address*device_feature_id*name*consolidate_all_sensors_to_one_record|next_sensor...
const int sensor_id = 280; //SENSORS! -- we support these: 2320 for AHT20, 75 for LM75, 85 for BMP085, 180 for BMP180, 2301 for DHT 2301, 680 for BME680.  0 for no sensor.  No support for multiple sensors for now.
