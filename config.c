...
const char* sensor_config_string = ""; // "14*-1*2301*11*NULL*NULL*stank*1|0*-1*1*3*NULL*NULL*gassy*-1*1"; //an easy way to specify multiple sensors. the format is: dataPin*powerPin*sensorType*sensorSubType*i2c_address*device_feature_id*name*ordinal_of_overwrite*consolidateAllSensorsToOneRecord|next_sensor...
