...
The firmware of an ESP8266 in this system can be flashed remotely over the air if a good .bin flash file (which you can get out of the Arduino IDE) is placed in the directory specified in $flash_directory in config.php and you run the command <b>update firmware [name of file]<b>.
