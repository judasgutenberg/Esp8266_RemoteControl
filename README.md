...
In addition to configuration items on the master controller, this system also allows a user to change configuration items on an I2C slave using the <b>set slave xxx</b> and <b>get slave xxx</b> commands.
