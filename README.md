...
If you have a slave running <a href=https://github.com/judasgutenberg/twiboot/blob/master/README.md target=twiboot>my special customized version of Twiboot</a>, you can update its firmware <em>entirely over I2C</em> by issuing an <b>update slave firmware [location of firmware file]</b> to the master. 
