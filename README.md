...
For monitoring multiple weather sensors (placed, say, in various places inside and outside a building), there is a multi-plot graph displaying across different time scales.
