...
[https://github.com/judasgutenberg/Generic_Arduino_I2C_Slave](https://github.com/judasgutenberg/Arduino_I2C_Slave_With_Commands) and just add the I2C address of the slave Arduino to the device_type_feature record. Arduinos based on Atmega328s, Atmega168s, Atmega8s, Atmega32Us, and even LGT8F328P are ideal for use as slaves since they will not generally participate in slave uprisings.  Note: if you want to take advantage of my mechanism for remotely updating firmware on those slaves, you should stick with AVRs and you will need to use the I2C Slave With Commands.
