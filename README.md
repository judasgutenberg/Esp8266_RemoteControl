...
https://github.com/judasgutenberg/Generic_Arduino_I2C_Slave and just add the I2C address of the slave Arduino to the device_type_feature record. Arduinos based on Atmega328s, Atmega168s, and Atmega32Us are ideal for use as slaves.
