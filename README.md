...
If you want complete control of all the code of a robust remote-control, automation and  weather data logging system, you might be interested in this system. I developed it to most efficiently use solar energy at my off-grid cabin while also keeping the internet accessible and the pipes from freezing.  This started out as a simple multi-probe weather monitoring system to which I added first reliability automation, then remote control, then solar inverter monitoring, then home automation.  
