...
This system is multi-user and supports multiple user accounts, each with potentially multiple devices.  Once you place your user in the user table, here's an overview of how to set up control for a particular system controlled by a pin on your ESP8266:
